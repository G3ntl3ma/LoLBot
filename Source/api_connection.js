...
function getLeagueGames(league, date) {
    return __awaiter(this, void 0, void 0, function () {
        var query, matches, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    query = config_1.BASE_URL +
                        "ScoreboardGames&fields=Team1,Team2, DateTime_UTC&where=DateTime_UTC like '".concat(date, "%' and Tournament like '").concat(league, " %");
                    return [4 /*yield*/, fetch(query)];
                case 1:
                    matches = _a.sent();
                    return [4 /*yield*/, matches.json()];
                case 2: return [2 /*return*/, _a.sent()];
                case 3:
                    e_1 = _a.sent();
                    console.log("Query has failed: " + e_1);
                    return [3 /*break*/, 4];
...
console.log(getLeagueGames('LPL', '2024-02-25'));
